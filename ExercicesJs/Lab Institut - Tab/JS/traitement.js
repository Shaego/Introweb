...
function btnAdd_onclick()
{
    ...
    txtPrenom = parseInt(document.getElementById("txtPrenom").value);
    document.getElementById("lblMessageErreur").innerHTML=" Le membre " +txtNom +" " +txtPrenom +" a bien été ajouté";
